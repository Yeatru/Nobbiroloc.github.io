...
export const mockProducts: Product[] = [
  {
    ...
    images: ['https://via.placeholder.com/600x600?text=FDM+3D+Printer'],
    stock: 50,
    sales: 1234,
    rating: 4.8,
    reviews: 234,
  ...
  },
  {
    ...
    images: ['https://via.placeholder.com/600x600?text=SLA+Resin+3D+Printer'],
    stock: 30,
    sales: 567,
    rating: 4.9,
    reviews: 156,
  ...
  },
  {
    ...
    images: ['https://via.placeholder.com/600x600?text=SLS+Industrial+3D+Printer'],
    stock: 10,
    sales: 89,
    rating: 4.7,
    reviews: 45,
  ...
  },
  {
    ...
    images: ['https://via.placeholder.com/600x600?text=PLA+Filament+White'],
    stock: 200,
    sales: 5678,
    rating: 4.9,
    reviews: 890,
  ...
  },
  {
    ...
    images: ['https://via.placeholder.com/600x600?text=PETG+Filament+Clear'],
    stock: 150,
    sales: 3456,
    rating: 4.8,
    reviews: 567,
  ...
  },
  {
    ...
    applications: ['珠宝设计', '牙科模型', '手办制作', '精密零件'],
    images: ['https://via.placeholder.com/600x600?text=Resin+Gray+500ml'],
    stock: 80,
    sales: 1234,
    rating: 4.7,
    reviews: 234,
